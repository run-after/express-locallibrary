...
exports.bookinstance_delete_get = function(req, res, next) {
    ...
    BookInstance.findById(req.params.id).populate('book')
        .exec(function (err, instance) {
            if (err) { return next(err); }
            res.render('bookinstance_delete', { title: 'Delete Book instance', instance: instance })
        });
};
...
exports.bookinstance_update_get = function (req, res, next) {
    ...
    BookInstance.findById(req.params.id).exec(function (err, instance) {
        ...
        Book.find({}, 'title').exec(function (err, books) {
            if (err) { return next(err); }
            // Successful, so render.
            res.render('bookinstance_form', { title: 'Update Book Instance', bookinstance: instance, book_list: books });
        });
    });
};
